      ...
      <div dir="ltr" className="flex flex-col items-center gap-2 sm:gap-8 lg:flex-row lg:gap-0">
        ...
        <div dir="rtl" className="px-8 pt-0 pb-12 text-center text-black sm:px-12 lg:py-0 lg:w-1/2 lg:pl-2 lg:pr-16 lg:text-right">
          <div className="w-full lg:-translate-x-32">
            <h2 className={`${bebasNeue.className} text-[clamp(3.5rem,15vw,5.5rem)] leading-none tracking-tight sm:text-8xl lg:text-[clamp(48px,7.5vw,160px)]`}>
              POLARIZED-X
            </h2>
            <p className="-mt-2 text-xl font-semibold sm:text-xl lg:text-2xl">קלסיקה אמיתית שהולכת איתך.</p>
            <Link
              href="/shop"
              dir="rtl"
